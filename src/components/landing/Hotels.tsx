...
const hotels = [
  ...
  },
  {
    ...
    name: "Louvre Hotel",
    image:
      "https://images.unsplash.com/photo-1743410976099-6114097db9ba?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    rating: 7.0,
    stars: 4,
  },
  {
    ...
    <section className="py-10 px-4 bg-white">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="mt-4">
          <a
            href="#"
            className="text-[#a0927e] font-semibold text-sm inline-flex items-center"
          >
            View all (157)
            <svg
